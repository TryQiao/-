...
<body>
	<div id="wrapper">
        ...
        <form action="${basePath }/feedback_employee/updateFeedback" method="post">
        <div id="page-wrapper" >
	            <div class="row">
	                <div class="col-lg-12">
	                    <h1 class="page-header">编辑反馈信息</h1>
		                 ...
		                 <tr>
			                <td>
			                	...
			                	<label>姓名:</label>
						                ...
						                <input name="feedbackType" type="hidden" value="${feedbacks.feedbackType}">
			                	<tr>
				                	<td>
				                		<label>内容:</label>
								        <input class="form-control" name="feedbackContent" placeholder="输入内容" value="${feedbacks.feedbackContent }" style="width:260px;text-align:center" >
						                </td>
			                	</tr>
						       <tr>
							       <td>
							       	<label>时间:</label>
				                	<input class="form-control" name="feedbackDate" placeholder="输入时间" value="${feedbacks.feedbackDate }" style="width:160px;text-align:center">
							       </td>
						       </tr>
	               		</table>
 					</div>
