...
<body>
	<div id="wrapper">
        ...
        <form action="${basePath }/department/addDepartment" method="post">
        <div id="page-wrapper" >
	            <div class="row">
	                <div class="col-lg-12">
	             ...
	             <div class="form-inline" style="width:400px;padding-left:15px">
	                ...
	                <tr>
		                <td>
		                	<label>名称:</label>
		                	<input class="form-control" name="departmentName" placeholder="输入部门名称" style="width:230px;text-align:center">
		                </td>
	                </tr>
		            <tr>
		            	<td>	
		            		<label>人数:</label>
		                	<input class="form-control" name="departmentNumber" placeholder="输入部门人数" style="width:160px;text-align:center">
		            	</td>
		            <tr>    
		            <tr>
		            	<td> 
