...
<body>
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">员工职务信息</h1>
                </div>
                <div class="check-div form-inline">
                    
                    <div class="col-xs-4" style="height: 45px;">
                   		<form  action="${basePath}/employee/listEmployeePost" method="post" >
                                ...
                                <c:forEach items="${employees}" var="employee" varStatus="status">
                                    <tr class="odd gradeX">
                                        ...
                                        <td>${employee.employeeId}</td>
						           		...
						           		<td>
						           			<a href="${basePath}/employee/findEmployeePost?employeeId=${employee.employeeId}" class="active"><i  class="fa fa-cog fa-fw" style="font-size: 20px;"></i></a>
						           		</td>
                                    </tr>
                                 </c:forEach>
                                     </tbody>
