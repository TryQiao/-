...
<body>
	<div id="wrapper">
        ...
        <form action="${basePath }/pay/addPay" method="post">
        <div id="page-wrapper" >
	            <div class="row">
	                <div class="col-lg-12">
	                    <h1 class="page-header">添加薪资</h1>
	            ...
	            <div style="width: 1200px;padding-left:15px">
	                ...
	                <table  class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:35%;">
	                	<tr>
	                		<td>
			                	  <label>员工:</label>
					                <select class="form-control form-control-sm" name="empl.employeeId" style="width:100px">
				       ...
				       <tr>
					       <td>
					       		<label>补助:</label>
				                <input class="form-control" name="paySupply" placeholder="输入补助" style="width:120px;text-align:center">
					       </td>
				       </tr>
		                <tr>
					       <td>
					       		<label>基本工资:</label>
				                <input class="form-control" name="payBaseMoney" placeholder="输入基本工资" style="width:180px;text-align:center">
					       </td>
				       </tr> 		 
