...
<body>
	<div id="wrapper">
        ...
        <form action="${basePath }/reward/addReward" method="post">
        <div id="page-wrapper" >
	            <div class="row">
	                <div class="col-lg-12">
	                    <h1 class="page-header">添加奖惩</h1>
	            ...
	            <div style="width: 1200px;padding-left:15px">
	                ...
	                <table  class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:40%;">
	                	...
	                	<tr>
		                	<td>
		                		<label>奖惩名称:</label>
				                <input class="form-control" name="rewardTitle" placeholder="输入奖惩名称" style="width:230px;text-align:center">
		                	</td>
	                	</tr>
	                	<tr>
	                		<td>
				                ...
				                <label>金额:</label>
				                <input class="form-control" name="rewardMoney" placeholder="输入金额" style="width:130px;text-align:center" >	
		               		</td>
	                	</tr>
	                	<tr>
	                		<td>
			                    ...
			                    <label>原因:</label>
				                <input class="form-control" name="rewardReason" placeholder="输入详细原因" style="width:260px;text-align:center" >
		                	</td>
	                	</tr>
	                	<tr>
	                		<td>
	                			 <label>时间:</label>
				                <input class="form-control" name="rewardTime" placeholder="输入时间" style="width:180px;text-align:center">
	                		</td>
	                	</tr>
		        	</table>
		        	</div>
