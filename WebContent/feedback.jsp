            ...
            <div class="row">
                ...
                <div class="check-div form-inline">
                    ...
                    <div class="col-xs-4" style="width: 100%;height: 45px;padding-left: 15px;">
                   		<form  action="${basePath}/feedback/listFeedback" method="post" >
                                ...
                                <c:forEach items="${feedbacks}" var="feedback" varStatus="status">
                                    <tr class="odd gradeX">
                                    	<td>${page.recordStart+status.index+1}</td>
						           		...
						           		<td>
						           			<a href="${basePath}/feedback/deleteFeedback?feedbackId=${feedback.feedbackId}" class="active"><i  class="fa fa-trash-o fa-fw" style="font-size: 20px;color:red"></i></a>
						           			<a href="${basePath}/feedback/findFeedback?feedbackId=${feedback.feedbackId}" class="active"><i class="fa fa-gear fa-fw" style="font-size: 20px"></i></a>
						           		</td>
