...
<body>
	<div id="wrapper">
        ...
        <form action="${basePath }/leaving_employee/addLeaving" method="post">
        <div id="page-wrapper" >
	            <div class="row">
	                <div class="col-lg-12">
	                    <h1 class="page-header">填写请假信息</h1>
	                ...
	                <div class="form-inline">
		                <table  class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:40%;">
		                 <tr>
			                <td>
			                	<input name="leavingId" type="hidden" value="${leaving.leavingId}">
			                	<label>姓名:</label>
			                	<%-- <label>员工:</label>
					                <select class="form-control form-control-sm" name="empleyees.employeeId" style="width:100px">
				               		  <option value="">-请选择-</option>
				               		  <c:forEach var="emp" items="${emps}" >
				               		  	<option value="${emp.employeeId}">${emp.employeeName}</option>
				               		  </c:forEach>
				               		</select> --%>
					                <input class="form-control" name="leavingName" placeholder="Enter text" value="${leavingName }" style="width:120px;text-align:center" disabled="">
						                <input name="leavingName" type="hidden" value="${leavingName}">
						                <label for="leavingType">类型:&nbsp;&nbsp;</label>
			                <select class="form-control form-control-sm" id="leavingType" name="leavingType">
			                	...
			                	<tr>
				                	<td>
				                		<label>请假详细原因:</label>
								        <input class="form-control" name="leavingReason" placeholder="输入内容"  style="width:260px;text-align:center" >
						                </td>
			                	</tr>
						       <tr>
							       <td>
							       	<label>时间:</label>
				                	<input class="form-control" name="leavingTime" placeholder="输入时间"  style="width:160px;text-align:center">
							       </td>
						       </tr>
	               		</table>
 					</div>
