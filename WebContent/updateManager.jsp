...
<body>
	<div id="wrapper">
        ...
        <form action="${basePath }/manager/updateManager" method="post">
        <div id="page-wrapper" >
	            <div class="row">
	                <div class="col-lg-12">
	                ...
	                <div class="form-inline">
		                <table  class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:40%;">
		                 <tr>
			                <td>
			                	<label>编号:</label>
			                	<input class="form-control" id="disabledInput" type="text" name="managerId" placeholder="Enter text" value="${managers.managerId }" style="width:80px;text-align:center" disabled="">
			                	<input name="managerId" type="hidden" value="${managers.managerId}">
			                	<tr>
				                	<td>
				                		<label>姓名:</label>
						                <input class="form-control" name="managerName" placeholder="输入姓名" value="${managers.managerName }" style="width:120px;text-align:center">
						                </td>
			                	</tr>
			                	<tr>
				                	<td>
						                ...
						                <select class="form-control" id="managerSex" name="managerSex" style="width:100px">
					                      ...
					                      <option value="男" <c:if test="${managers.managerSex eq '男' }">selected="selected"</c:if>>男</option>
					                      <option value="女" <c:if test="${managers.managerSex eq '女' }">selected="selected"</c:if>>女</option>
					               		</select>
					               		<label>电话:</label>
								        <input class="form-control" name="managerPhone" placeholder="输入电话" value="${managers.managerPhone }" style="width:120px;text-align:center">
				                	</td>
			                	</tr>
						       <tr>
							       <td>
							       	<label>密码:</label>
				                	<input class="form-control" name="managerPwd" placeholder="输入密码" value="${managers.managerPwd }" style="width:160px;text-align:center">
							       </td>
						       </tr>
	               		</table>
 					</div>
