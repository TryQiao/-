...
<body>
	<div id="wrapper">
        ...
        <form action="${basePath }/employee_employee/updateEmployee" method="post">
        <div id="page-wrapper" >
	            <div class="row">
	                <div class="col-lg-12">
	            ...
	            <div style="width: 1200px;padding-left: 30px;">
	                ...
	                <table  class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:60%;">
	                	...
	                	<tr>
	                		<td>
				                ...
				                <label>开始工作时间:</label>
				                <input class="form-control" value="${employees.employeeStarttime }" name="employeeStarttime" placeholder="输入开始工作时间" style="width:130px;text-align:center">
		                	</td>
	                	</tr>
	                	<tr>
	                		<td>
	                	...
	                	<tr>
	                		<td>
			               		<label>密码</label>
				                <input class="form-control" value="${employees.employeePwd }" name="employeePwd" placeholder="输入密码" style="width:130px;text-align:center">
	                	...
	                	<tr>
			                <td>
			                	<input type="submit" class="btn btn-danger" value="保存"></input>
		             			<a href="${basePath }/employee_employee/detailEmployee?employeeId=${employee.employeeId}"><input type="button" class="btn btn-primary" value="返回"></input></a>
			                </td>
			            </tr>
		        	</table>
		        	</div>
