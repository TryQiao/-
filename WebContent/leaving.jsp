            ...
            <div class="row">
                ...
                <div class="check-div form-inline">
                    ...
                    <div class="col-xs-4" style="width: 100%;height: 45px;padding-left: 15px;">
                   		<form  action="${basePath}/leaving/listLeaving" method="post" >
                   			<label>姓名:</label>
                   			 <select class="form-control form-control-sm" name="leavingName" style="width:100px">
				               		  <option value="">-请选择-</option>
				               		  <c:forEach var="leaving" items="${leavings}" >
					               		  	<option value="${leaving.leavingName}">${leaving.leavingName}</option>
				               		  </c:forEach>
				               		</select>
				            
	                        <label style ="padding-left:26px">请假类型:</label>
                 ...
                 <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align:center">
                                ...
                                <c:forEach items="${leavings}" var="leaving" varStatus="status">
                                    <tr class="odd gradeX">
                                    	<td onclick="alert('不是员工本人，无修改的权限！');" style="cursor:pointer" >${leaving.leavingId}</td>
                                        <td onclick="alert('不是员工本人，无修改的权限！');" style="cursor:pointer" >${leaving.leavingName}</td>
                                        <td onclick="alert('不是员工本人，无修改的权限！');" style="cursor:pointer" >${leaving.leavingType}</td>
						           		<td onclick="alert('不是员工本人，无修改的权限！');" style="cursor:pointer" >${leaving.leavingReason}</td>
						           		<td onclick="alert('不是员工本人，无修改的权限！');" style="cursor:pointer" >${leaving.leavingTime}</td>
						           		<td >
	                                        <a href="${basePath}/leaving/deleteLeaving?leavingId=${leaving.leavingId}" class="active"><i  class="fa fa-trash-o fa-fw" style="font-size: 20px;color:red"></i></a>
<%-- 						           			<a href="${basePath}/leaving/findLeaving?leavingId=${leaving.leavingId}" class="active"><i class="fa fa-gear fa-fw" style="font-size: 20px"></i></a>
 --%>						           		</td>
                                    </tr>
                                 </c:forEach>
                                     </tbody>
